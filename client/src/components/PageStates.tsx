...
export function EmptyAdminState({ title = "Cadastre a primeira prefeitura", description = "A área pública permanece pronta para consulta e exibirá estados vazios até que dados oficiais sejam incluídos." }: { title?: string; description?: string }) {
